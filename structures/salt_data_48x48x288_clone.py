"""
salt_data_48x48x288_clone.py  (generated by build_salt_data.py - do not edit by hand)
========================================================================

Box:            4.8 x 4.8 x 28.8 nm    A = 23.040 nm^2
Waters to pack: 22178   (at 55.5 M)
Temperature:    298.15 K
Edge tolerance: C(edge)/C(0) <= 9.999999999999974e-13

Restraint parameters - fixed for this box, valid at EVERY target molality:

    HP   k_HP        = 0.6606 kJ/mol/nm^2     z0 = 14.4 nm
         sigma       = 1.937 nm   (4 sigma = 7.748 nm)
    FBP  delta_z     = 2.4278 nm            z0 = 14.4 nm
...
k_HP, delta_z_FBP and num_particles were copied verbatim from
salt_data_48x48x144.py (Lz = 14.4 nm) so that ONLY the
...
BOX = {
    ...
    'area': 23.04,
    'volume_nm3': 663.552,
    'volume_L': 6.63552e-22,
    'n_water': 22178,
    'mass_water_kg': 6.63456560985466e-22,
    'temperature': 298.15,
    'edge_tol': 9.999999999999974e-13,
    'reference_temperature': 298.15,
    'water_molarity': 55.5,
    'k_HP': 0.6606492479786179,
    'delta_z_FBP': 2.4277779652589224,
    'k_FBP_wall': 4184.0,
    'z_center': 14.4,
    'sigma': 1.9370865555374897,
    'four_sigma': 7.748346222149959,
    'erf_correction': 0.9999999999998945,
    'molal_factor': 0.9998561695021129,
    'cloned_from': 'salt_data_48x48x144.py',
    'cloned_from_lz': 14.4,
}
...
def lookup(salt, molality, tol=1e-6):
    ...
    for d in salt_infos:
        if d["salt"] == salt and abs(d["molality"] - molality) < tol:
            return SaltData(**d)
    raise KeyError(f"{salt} at {molality} mol/kg not in salt_data_48x48x288_clone.py")
