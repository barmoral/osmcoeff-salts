"""
salt_data_48x48x144.py  (generated by build_salt_data.py - do not edit by hand)
==================================================================

Box:            4.8 x 4.8 x 14.4 nm    A = 23.040 nm^2
Waters to pack: 11089   (at 55.5 M)
Temperature:    298.15 K
Edge tolerance: C(edge)/C(0) <= 0.001

Restraint parameters - fixed for this box, valid at EVERY target molality:

    HP   k_HP        = 0.6606 kJ/mol/nm^2     z0 = 7.2 nm
         sigma       = 1.937 nm   (4 sigma = 7.748 nm)
    FBP  delta_z     = 2.4278 nm            z0 = 7.2 nm
...
BOX = {
    ...
    'area': 23.04,
    'volume_nm3': 331.776,
    'volume_L': 3.31776e-22,
    'n_water': 11089,
    'mass_water_kg': 3.31728280492733e-22,
    'temperature': 298.15,
    'edge_tol': 0.001,
    ...
    'erf_correction': 0.9997983354812846,
...
def lookup(salt, molality, tol=1e-6):
    ...
    for d in salt_infos:
        if d["salt"] == salt and abs(d["molality"] - molality) < tol:
            return SaltData(**d)
    raise KeyError(f"{salt} at {molality} mol/kg not in salt_data_48x48x144.py")
