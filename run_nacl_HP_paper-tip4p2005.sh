...
#SBATCH --gres=gpu
#SBATCH --mem=4000m
#SBATCH --job-name=HP_nacl_paperbox_t4p2005
#SBATCH --output=slurm_codes/HP_nacl_paperbox_t4p2005.%j.log
...
export WATER="TIP4P2005"                # must NOT be "TIP3P"
...
export FF_WATER='tip4p_2005.offxml'
