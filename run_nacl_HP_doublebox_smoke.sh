...
#SBATCH --gres=gpu
#SBATCH --mem=6000m
#SBATCH --job-name=HP_nacl_db35msmoke
#SBATCH --output=slurm_codes/HP_nacl_db35msmoke.%j.log
...
export CASE=${RESTRAINT}_$(echo ${SALT} | tr -d ' ')_${WATER}_${PDB_SUFFIX}box_smoke
