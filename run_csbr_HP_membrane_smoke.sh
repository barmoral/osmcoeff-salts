...
#SBATCH --gres=gpu
#SBATCH --mem=6000m
#SBATCH --job-name=HP_csbr_35m156_tip4p_smoke
#SBATCH --output=slurm_codes/HP_csbr_35m156_tip4p_smoke.%j.log
...
export CASE=${RESTRAINT}_$(echo ${SALT} | tr -d ' ')_${WATER}_156_smoke
